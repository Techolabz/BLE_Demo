...
public class MainActivity extends Activity {
    ...
    byte[] suburlArray=new byte[2000];
    byte[] urlArray=new byte[2000];
    byte[] suffArray=new byte[500];
    @Override
                                             ...
                                             if ((byte5.equals("3")) && (byte6.equals("aa")) && (byte7.equals("fe"))) {
                                                 ...
                                                 if ((byte9.equals("16")) && (byte10.equals("aa")) && (byte11.equals("fe"))) {
                                                     ...
                                                     if ((byte12.equals("0"))) {
                                                         ...
                                                         for (int l = 14; l < (14 + Integer.parseInt(byte8)); l++) {
                                                             ...
                                                             if (url_flag == 0) {
                                                                 j++;
                                                                 urlArray[j] = scanRecord[l];
                                                                 byteurl = byteurl + Integer.toHexString(urlArray[j]);

                                                             }
                                                             if (url_flag == 2) {
                                                                 k++;
                                                                 suburlArray[k] = scanRecord[l];
                                                                 bytesuburl = bytesuburl + Integer.toHexString(suburlArray[k]);

                                                             }

                                                             if (url_flag == 1) {
                                                                 suffArray[0] = scanRecord[l];
                                                                 lenSuffix = Integer.toHexString(suffArray[0]);
                                                                 url_flag = 2;
                                                             }
